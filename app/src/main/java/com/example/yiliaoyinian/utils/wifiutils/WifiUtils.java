...
public class WifiUtils {
    ...
    public void connectWifiNoPws(String ssid){
        Log.d("MainActivity", "connectWifiNoPws传进来的: "+"\""+ssid+"\"");
        try {
            for (WifiConfiguration configuredNetwork : wifiManager.getConfiguredNetworks()) {
                Log.d("MainActivity", "connectWifiNoPws: "+configuredNetwork.SSID);
                if (configuredNetwork.SSID.contains(ssid)){
                    Log.d("MainActivity", "找到包含的ssid");
    ...
    public void connectWifiNoPws2(String ssid){
        Log.d("MainActivity", "connectWifiNoPws传进来的: "+"\""+ssid+"\"");
        try {
            for (WifiConfiguration configuredNetwork : wifiManager.getConfiguredNetworks()) {
                Log.d("MainActivity", "connectWifiNoPws: "+configuredNetwork.SSID);
