...
import com.example.yiliaoyinian.databinding.ActivityRenTiChuanGanQiSettingBinding;
...
public class RenTiChuanGanQiSettingActivity extends AppCompatActivity {
     private ActivityRenTiChuanGanQiSettingBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityRenTiChuanGanQiSettingBinding.inflate(getLayoutInflater());
        ...
        binding.rl1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final QMUIDialog.EditTextDialogBuilder builder = new QMUIDialog.EditTextDialogBuilder(RenTiChuanGanQiSettingActivity.this);
                builder.setTitle("修改设备名称")
                        .setSkinManager(QMUISkinManager.defaultInstance(RenTiChuanGanQiSettingActivity.this))
        ...
        binding.yichu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new CommomDialog(RenTiChuanGanQiSettingActivity.this, R.style.dialogs, "确定要移除设备?", new CommomDialog.OnCloseListener() {
                    @Override
                    public void onClick(Dialog dialog, boolean confirm) {
                        Log.d("DAFragment3", "confirm:" + confirm);
                        if (confirm) {
                            //退出动作
                            qmuiTipDialog = new QMUITipDialog.Builder(RenTiChuanGanQiSettingActivity.this)
    ...
    private void loginApiununBind(String did){ //解除绑定
        ...
        MyApplication.okHttpClient.newCall(builder).enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                if (!RenTiChuanGanQiSettingActivity.this.isFinishing())
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                Log.d("RenTiChuanGanQiActivity", "设备属性请求地址:" + call.request().url());
                try {
                    if (!RenTiChuanGanQiSettingActivity.this.isFinishing())
                    runOnUiThread(new Runnable() {
                        @Override
