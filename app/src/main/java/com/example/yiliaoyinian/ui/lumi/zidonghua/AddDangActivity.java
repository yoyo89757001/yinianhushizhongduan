...
import com.example.yiliaoyinian.databinding.ActivityAddDangBinding;
...
public class AddDangActivity extends AppCompatActivity {
    private ActivityAddDangBinding binding=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityAddDangBinding.inflate(getLayoutInflater());
        ...
        bianQianAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                switch (dangBeanList.get(position).getName()){
                    case "自动化":
                           startActivity(new Intent(AddDangActivity.this,ZDHListActivity.class));
                        break;
                    case "定时":
                           startActivity(new Intent(AddDangActivity.this,DingShiActivity.class));
                        break;
                    default:
                        startActivity(new Intent(AddDangActivity.this,DongZuoListActivity.class).putExtra("WGInfoSave",dangBeanList.get(position)));
                        break;
                }
