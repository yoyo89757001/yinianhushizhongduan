...
import com.example.yiliaoyinian.databinding.ActivityWuXianKaiGuanSettingBinding;
...
public class WuXianKaiGuanSettingActivity extends AppCompatActivity {
    private ActivityWuXianKaiGuanSettingBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityWuXianKaiGuanSettingBinding.inflate(getLayoutInflater());
        ...
        binding.rl1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final QMUIDialog.EditTextDialogBuilder builder = new QMUIDialog.EditTextDialogBuilder(WuXianKaiGuanSettingActivity.this);
                builder.setTitle("修改设备名称")
                        .setSkinManager(QMUISkinManager.defaultInstance(WuXianKaiGuanSettingActivity.this))
        ...
        binding.yichu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new CommomDialog(WuXianKaiGuanSettingActivity.this, R.style.dialogs, "确定要移除设备?", new CommomDialog.OnCloseListener() {
                    @Override
                    public void onClick(Dialog dialog, boolean confirm) {
                        Log.d("DAFragment3", "confirm:" + confirm);
                        if (confirm) {
                            //退出动作
                            qmuiTipDialog = new QMUITipDialog.Builder(WuXianKaiGuanSettingActivity.this)
    ...
    private void loginApiununBind(String did){ //解除绑定
        ...
        MyApplication.okHttpClient.newCall(builder).enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                if (!WuXianKaiGuanSettingActivity.this.isFinishing())
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                try {
                 ...
                 //   if (healthBean.getCode()==0){
                        ...
                        finish();
                 //   }
                    // Log.d("WGSettinActivity", "查询设备属性的历史值request:"+stA);
