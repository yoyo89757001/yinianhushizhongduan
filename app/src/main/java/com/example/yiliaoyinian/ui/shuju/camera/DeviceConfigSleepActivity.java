...
public class DeviceConfigSleepActivity extends BaseActivity implements View.OnClickListener {
...
//    @BindView(R.id.name)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_config_sleep);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.peiwang_rl:
                startActivity(new Intent(this,DeviceWifiActivity.class));
                break;
        }
    }
}
