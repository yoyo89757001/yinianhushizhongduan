...
public class FinshAdapter extends BaseQuickAdapter<UnFinshBean.ResultBean, BaseViewHolder> implements LoadMoreModule {


    public FinshAdapter(int layoutResId, @Nullable List<UnFinshBean.ResultBean> data) {
