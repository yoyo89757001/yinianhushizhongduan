...
public class DragFloatActionButton extends FloatingActionButton {
    ...
    public DragFloatActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
       ...
       // Log.d("DragFloatActionButton", "slop:" + slop);
    }

    private OnLstion onLstion;
    private int lastX;
    private int lastY;

    private boolean isDrag;
    public void setOnLstion(OnLstion onLstion){
        this.onLstion=onLstion;
    }
    ...
    public interface OnLstion{
        public void isLL(boolean is);
